...
/* testimonial  */
  ...
  .slick-slide {
    ...
    margin-left: clamp(2px, 0.5vw, 10px);
  ...
  .left-testimonial-section {
    background-color: #c8c6c682;
    border-radius: 8px 8px 6px 6px;
    flex-shrink: 0;
  }
  
  .left-testimonial-section img {
  ...
  /* Extra small screens - 533px and below */
  ...
  /* Very small screens like Samsung Fold */
...
/* Reduce card width and make them more compact */
.slick-slide {
  max-width: 320px;
  margin: 0 10px;
  opacity: 0.4;
...
/* Center slide should be full opacity and scale */
.slick-center {
  opacity: 1 !important;
  transform: scale(1) !important;
}

/* Center align slides inside the track */
.slick-track {
  display: flex !important;
  justify-content: center;
  align-items: center;
...
/* Optional: Slightly reduce padding inside cards */
.testimonial-card {
  padding: 20px;
  background: #f7f7f7;
  border-radius: 10px;
